...
class HealthWorkerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.communityhealthworker.index')->withCommunityhealthworker($health_worker);
    }
    ...
    public function create()
    {
        ...
        return view('staff.communityhealthworker.create')->withChw($chwType);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('staff/communityhealthworker');
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.communityhealthworker.edit')->withWorker($health_worker)->withChw($chwType);
    }
