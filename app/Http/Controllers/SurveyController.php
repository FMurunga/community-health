...
class SurveyController extends Controller
{
    ...
    public function index()
    {
        //
        $survey=Survey::all();
        return view('hospital.surveys.index')->withsurveys($survey);
    }
    ...
    {
        //
        return view('hospital.surveys.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('hospital/surveys');
    ...
    public function edit($id)
    {
        ...
        return view('hospital.surveys.edit')->withSurveys($survey);
