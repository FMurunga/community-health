@extends('community healthworker.layout.app')

@section('page_title', 'Edit Taks')
    	...
    	<div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title text-center">Edit Tasks</h4>
                        <div class="row justify-content-center">
                        	<div class="col-md-8">
                        		<form method="POST" action="{{ url('communityhealthworker/tasks', $task->id) }}">
                        			{{ csrf_field() }}
                        			{{ method_field('PATCH') }}
