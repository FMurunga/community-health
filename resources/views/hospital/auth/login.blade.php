...
<div class="wrapper-page">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="text-muted text-center font-18"><b>Facility Log In</b></h4>

            <div class="p-3">
                <form class="form-horizontal m-t-20" role="form" method="POST" action="{{ url('/hospital/login') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group m-t-10 mb-0 row">
                        <div class="col-sm-7 m-t-20">
                            <a href="{{ url('/hospital/password/reset') }}" class="text-muted"><i class="mdi mdi-lock    "></i> Forgot your password?</a>
                        </div>
                        <div class="col-sm-5 m-t-20">
                            <a href="{{ url('/hospital/register') }}" class="text-muted"><i class="mdi mdi-account-circle"></i> Create an account</a>
                        </div>
                    </div>
                </form>
            </div>
