...
@section('page_title', 'Add Health Worker')
    	...
    	<div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title text-center">Add Health Worker</h4>
                        <div class="row justify-content-center">
                        	<div class="col-md-8">
                        		<form method="POST" action="{{ url('hospital/communityhealthworker') }}">
                        			{{ csrf_field() }}
                        			<div class="form-group row">
			                            <div class="col-sm-12">
			                            	<label for="name" class="">Name</label>
			                                <input class="form-control {{ $errors->has('name') ? 'parsley-error' : '' }}" type="text" value="{{ old('name') }}" placeholder="Health Worker name" id="name" name="name">
			                                @if ($errors->has('name'))
			                        ...
			                        <div class="form-group row">
			                            <div class="col-sm-12">
			                            	<label for="phone">Health Worker Type</label>
