            ...
            <div class="left side-menu">
                ...
                <div class="sidebar-inner slimscrollleft">
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="{{ url('/hospital/home') }}" class="waves-effect">
                                    <i class="ti-home"></i>
                                    <span> Dashboard </span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ url('hospital/communityhealthworker') }}" class="waves-effect">
                                    <i class="ti-home"></i>
                                    <span>Health Worker</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('hospital/houses') }}" class="waves-effect">
                                    <i class="ti-home"></i>
                                    <span> Households </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('hospital/patientreferrals') }}" class="waves-effect">
                                    <i class="ti-home"></i>
                                    <span> Referrals</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('hospital/surveys') }}" class="waves-effect">
                                    <i class="ti-home"></i>
                                    <span> Surveys </span>
                                </a>
                            </li>
