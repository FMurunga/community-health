                        ...
                        <table class="table">
                            ...
                            <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<a href="{{ url('staff/houses', $house->id) }}" class="btn btn-success btn-xs">Edit</a>

	                                	<a href="javascript:void(0);" onclick="event.preventDefault();
	                                                document.getElementById('{{$houses->id}}').submit();"
	                                                class="btn btn-danger btn-xs">Delete</a>
	                                	<form method="POST" id="{{$house->id}}" action="{{ url('staff/houses',$house->id) }}" accept-charset="UTF-8">
											{{ csrf_field() }}
	                        				{{ method_field('DELETE') }}
										</form>
	                                </td>
