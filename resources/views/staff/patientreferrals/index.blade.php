                        ...
                        <table class="table">
                            ...
                            <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<a href="{{ url('hospital/patientreferrals', $patient_referral->id) }}" class="btn btn-success btn-xs">Edit</a>

	                                	<a href="javascript:void(0);" onclick="event.preventDefault();
	                                       document.getElementById('{{$patient_referral->id}}').submit();"
	                                                class="btn btn-danger btn-xs">Delete</a>
	                                	<form method="POST" id="{{$patient_referral->id}}" action="{{ url('hospital/patientreferrals',$patient_referral->id) }}" accept-charset="UTF-8">
											{{ csrf_field() }}
	                        				{{ method_field('DELETE') }}
										</form>
	                                </td>
